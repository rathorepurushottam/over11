import { View, Text, StatusBar, Image, FlatList, Modal, Platform, StyleSheet, Dimensions } from 'react-native';
...
import { scan, copy, downArrow, done, kycLogo, panIcon, bankIcon, upiIcon, checkAdhaar } from '../../helper/image';
      ...
      <CommonImageBackground common>
        ...
        <KeyBoardAware style={styles.bottomContainer}>
          ...
          <TouchableOpacityView
            ...
            {isVerified('EMAIL') ?
              <FastImage source={checkAdhaar} resizeMode='contain' style={styles.checkIcon} />
              : checkInProgress('EMAIL') ? <AppText type={THIRTEEN} weight={POPPINS_SEMI_BOLD} color={RED}>
                In Progress
              </AppText> :
                <PrimaryButton
                  type={ELEVEN}
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalContainer}>
              ...
              <FastImage source={done}
                resizeMode='contain' style={{ height: 60, width: 60, alignSelf: "center" }} />
              <PrimaryButton
                onPress={() => { setIsModalVisible(false), NavigationService.navigate(MY_BALANCE) }}
                buttonStyle={{ marginTop: 10, alignSelf: 'center', width: '90%' }}
                title="WITHDRAWAL"
              />
            </View>
          </View>
